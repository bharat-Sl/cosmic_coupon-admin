...
class CategoryDetail extends React.Component {
    ...
    componentDidMount = () => {
        this.getSingleCategory(sessionStorage.getItem("cat_id"))
        this.getCategoryDeal(sessionStorage.getItem("cat_id"))
        this.getAllStore()
        this.changeCurrency()
    ...
    getCategoryDeal = (cat_id,category=null, stores=null) => {
        var data = {
            cat_id:cat_id,
    ...
    CheckCategory = (event, id) => {
        ...
        setTimeout(() => {
            this.getCategoryDeal(sessionStorage.getItem("cat_id"), this.state.days, this.state.stores)
        }, 200);
    ...
    getSingleCategory = (category_id) => {
        ...
        Axios.post(`${this.state.url}/front/auth/get/single-category`,{data:category_id}, {
            ...
            setTimeout(() => {
                this.setState({
                    loading:false,
                    showCat:true,
                    SingleCat:res.data.data.category,
                    CategoryName:res.data.data.category.cat_name
                })
            }, 100);
            ...
            <div className="">
                ...
                <div class="coupon-main-section">
                    ...
                    <div class="searchby-filter">
                        ...
                        <div class="col-md-9">
                            <h1 class="filter-text">{(this.state.days != ""|| this.state.stores != "") ? "Search Record" : this.state.CategoryName} </h1> 
                            ...
                            {this.state.allDeal.length > 0 && <>
                                {this.state.allDeal.map((list, index) => {
                                    // var amount = this.changeCurrency(list.discount)
                                    var discount_type = "";
         ...
         <div class="row">
           ...
           <div class="col-md-7">
             ...
             <li class="money">
                  ...
                  <p>{sessionStorage.getItem("currency")} {this.convertAmount(this.state.price-this.state.discount)} <span>{sessionStorage.getItem("currency")} {this.state.price}</span></p>
                  </>}
                ...
                <li class="share-url">
                  ...
                  <p class="url-sec"><i class="fa fa-files-o" aria-hidden="true"></i><h6>{this.state.link}</h6><span class="content">
         ...
         <div class="row">
           ...
           <div class="col-md-7">
             <ul class="text-area">
                ...
                <li class="share-url">
                  <p class="heading">Share Url</p>
                  <p class="url-sec"><i class="fa fa-files-o" aria-hidden="true"></i><h6>{this.state.link}</h6></p>
                </li>
                <li class="code"> 
