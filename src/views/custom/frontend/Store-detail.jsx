...
class StoreDetail extends React.Component {
    ...
    componentDidMount = () => {
        this.getSingleStore(sessionStorage.getItem("store_id"))
        this.getStoreDeal(sessionStorage.getItem("store_id"))
        this.getAllStore()
        this.changeCurrency()
  ...
  convertAmount(baseAmt){
    ...
    getStoreDeal = (store_id,cat_id=null, stores=null) => {
        var data = {
            store_id:store_id,
        ...
        Axios.post(`${this.state.url}/front/auth/get/store-deal`,{data:data}, {
            ...
            setTimeout(() => {
                this.setState({
                    ...
                    allCoupon:res.data.data.StoreCoupon
                })
    ...
    CheckCategory = (event, id) => {
        ...
        setTimeout(() => {
            this.getStoreDeal(sessionStorage.getItem("store_id"), this.state.days, this.state.stores)
        }, 200);
    ...
    getSingleStore = (store_id) => {
        ...
        Axios.post(`${this.state.url}/front/auth/get/single-store`,{data:store_id}, {
            ...
            setTimeout(() => {
                this.setState({
                    loading:false,
                    showCat:true,
                    SingleStore:res.data.data.category,
                    StoreName:res.data.data.category.name
                })
            }, 100);
    ...
    showDeal = (e,index) => {
      var discount = "";
        if(sessionStorage.getItem('_access')){
            ...
            //    discount = selected.price-selected.price*selected.discount/100;
            // }else{
            //    discount = selected.discount;
            // }
        this.setState({
            price:this.convertAmount(selected.price),
            discount:selected.discount ,
            ...
            <div className="">
                ...
                <div class="coupon-main-section">
                    ...
                    <div class="searchby-filter">
                        ...
                        <div class="col-md-9">
                        <h1 class="filter-text">{(this.state.days != ""|| this.state.stores != "") ? "Search Record" : this.state.StoreName} </h1> 
                            ...
                            return <div class="promo-code-main-section">
                                <div class="row">
                                    ...
                                    <div class="discount-offer">
                                        <div class="discount">
                                        {list.discount_type === 'amount' && <> <p>{this.convertAmount(list.discount)} {discount_type}<br></br>Off</p>
                                            </>}

                                            {list.discount_type === 'percent' && <> <p>{list.discount} %<br></br>Off</p>
                                            </>}
                                        </div>
                                        {/* <div class="like-dislike">
                                            <p>77% Success</p>
                                    ...
                                    <div class="discount-detail">
                                        <div class="row">
                                            <div class="col-md-8">
                                            <img src={this.state.image_url+'deal/'+list.image} class=""alt="" width="100px;"/>
                                                <form action="" class="drop-down">
                                                        {/* <input type="checkbox" id="vehicle1" name="check1"/> */}
                                                        <label for="vehicle1">{list.title}</label>
                                                    </form>
                                                    {list.discount_type === 'amount' && <><p>Upto {this.convertAmount(list.discount)} {discount_type} Off on {list.title}</p>
                                                    </>}

                                                    {list.discount_type === 'percent' && <><p>Upto {list.discount} % Off on {list.title}</p>
                                                    </>}
                                                </div>
                                            <div class="col-md-4">
                            ...
                            return <div class="promo-code-main-section">
                                <div class="row">
                                    ...
                                    <div class="discount-detail">
                                        <div class="row">
                                            <div class="col-md-8">
                                            <img src={this.state.image_url+'coupon/'+list.image} class=""alt="" width="100px;"/>
                                                <form action="" class="drop-down">
                                                        {/* <input type="checkbox" id="vehicle1" name="check1"/> */}
         ...
         <div class="row">
           ...
           <div class="col-md-7">
             ...
             <li class="money">
                  ...
                  <p>{sessionStorage.getItem("currency")} {this.convertAmount(this.state.discount)} Off<span>{sessionStorage.getItem("currency")} {this.state.price}</span></p>
                  </>}

                  {this.state.discount_type === 'percent' && <> 
                  <p> {this.state.discount} % Off<span>{sessionStorage.getItem("currency")} {this.state.price}</span></p>
                  </>}
                </li>
                <li class="view-btn">
                ...
                <li class="share-url">
                  ...
                  <p class="url-sec">
                  <i class="fa fa-files-o" aria-hidden="true"></i><h6>{this.state.link}</h6><span class="content">
                   <CopyToClipboard  onCopy={this.onCopy} text={this.state.link}>
                   <button>{this.state.copied ? <span class="btn">Copied</span> : "Copy"}</button>
                   </CopyToClipboard>
                  </span>
                  </p>
                </li>
           ...
           <div class="col-md-7">
             <ul class="text-area">
                ...
                <li class="share-url">
                  <p class="heading">Share Url</p>
                  <p class="url-sec">
                    <i class="fa fa-files-o" aria-hidden="true"></i><h6>{this.state.link}</h6>
                  </p>
                </li>
               <li class="code"> 
                  <p>Coupon Code <span class="link">{this.state.code}</span>
                  <CopyToClipboard  onCopy={this.onCopy} text={this.state.code}>
                    <button>{this.state.copied ? <span class="copy" style={{color: 'red'}}>Copied.</span> : "Copy"}</button>
                  </CopyToClipboard>
                  </p>
              </li>
